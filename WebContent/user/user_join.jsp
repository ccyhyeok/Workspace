				...
				<div class="col-lg-6 col-md-9 col-sm-12 join-form">
					...
					<form action="user_join_con.jsp" method="post">
						<div class="form-group">
							<label for="id">아이디</label> <input type="text" name="pr-id"
								class="form-control" id="id" placeholder="아이디를 (영문포함 4~12자 이상)">
						</div>
						<div class="form-group">
							<label for="password">비밀번호</label> <input type="password"
								name="pr-password" class="form-control" id="password"
						...
						<div class="form-group">
							<label for="name">이름</label> <input type="text" name="pr-name"
						...
						<div class="form-group">
							<label for="hp">이메일</label><br> <input
								class="form-control sel" name="pr-email">
						...
						<div class="form-group">
							<label for="addr-num">주소</label> <input type="text"
								name="pr-address" class="form-control" id="addr-basic"
								placeholder="기본주소">
						</div>
						<!--  <div class="form-group">
						...
						<div class="form-group">
							<!--   <button type="button" name="pr-join" class="btn btn-lg btn-success btn-block">회원가입</button>
 -->
							<input type="submit" value="등록" href="user_login.jsp">
						</div>
						<div class="form-group">
							<button type="button" name="pr-login"
